...
enum ApiEndpoint: Endpoint {
    ...
    case postMessage(roomId: String, message: ChatMessageDTO)
    ...
    var path: String {
        ...
        case .getMessage(let roomId, _): return "/chats/\(roomId)"
        case .postMessage(let roomId, _): return "/chats/\(roomId)"
